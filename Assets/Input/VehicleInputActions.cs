...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Input/VehicleInputActions.inputactions".
/// </summary>
/// <remarks>
...
public partial class @VehicleInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": [
        ...
        m_Drive_Attack = m_Drive.FindAction("Attack", throwIfNotFound: true);
        m_Drive_Interact = m_Drive.FindAction("Interact", throwIfNotFound: true);
        m_Drive_Crouch = m_Drive.FindAction("Crouch", throwIfNotFound: true);
        m_Drive_HandBrake = m_Drive.FindAction("HandBrake", throwIfNotFound: true);
        m_Drive_Previous = m_Drive.FindAction("Previous", throwIfNotFound: true);
        m_Drive_Next = m_Drive.FindAction("Next", throwIfNotFound: true);
        m_Drive_Sprint = m_Drive.FindAction("Sprint", throwIfNotFound: true);
        // UI
    ...
    private readonly InputAction m_Drive_Attack;
    private readonly InputAction m_Drive_Interact;
    private readonly InputAction m_Drive_Crouch;
    private readonly InputAction m_Drive_HandBrake;
    private readonly InputAction m_Drive_Previous;
    private readonly InputAction m_Drive_Next;
    private readonly InputAction m_Drive_Sprint;
    /// <summary>
    ...
    public struct DriveActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "Drive/Look".
        /// </summary>
        public InputAction @Look => m_Wrapper.m_Drive_Look;
        /// <summary>
        /// Provides access to the underlying input action "Drive/Attack".
        /// </summary>
        public InputAction @Attack => m_Wrapper.m_Drive_Attack;
        /// <summary>
        /// Provides access to the underlying input action "Drive/Interact".
        /// </summary>
        public InputAction @Interact => m_Wrapper.m_Drive_Interact;
        /// <summary>
        /// Provides access to the underlying input action "Drive/Crouch".
        /// </summary>
        public InputAction @Crouch => m_Wrapper.m_Drive_Crouch;
        /// <summary>
        /// Provides access to the underlying input action "Drive/HandBrake".
        /// </summary>
        public InputAction @HandBrake => m_Wrapper.m_Drive_HandBrake;
        /// <summary>
        /// Provides access to the underlying input action "Drive/Previous".
        /// </summary>
        public InputAction @Previous => m_Wrapper.m_Drive_Previous;
        /// <summary>
        /// Provides access to the underlying input action "Drive/Next".
        /// </summary>
        public InputAction @Next => m_Wrapper.m_Drive_Next;
        /// <summary>
        /// Provides access to the underlying input action "Drive/Sprint".
        /// </summary>
        public InputAction @Sprint => m_Wrapper.m_Drive_Sprint;
        /// <summary>
